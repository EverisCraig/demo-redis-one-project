package com.craig.pe.demoredisoneproject.service;

import com.craig.pe.demoredisoneproject.config.CacheConfig;
import com.craig.pe.demoredisoneproject.entities.User;
import com.craig.pe.demoredisoneproject.repository.UserRepository;
...
public class UserService {
    ...
    public User updateSalary(Long id, float salary) {
        ...
        return res > 0 ? this.userRepository.findById(id)
                .orElse(null) : null;
    }
